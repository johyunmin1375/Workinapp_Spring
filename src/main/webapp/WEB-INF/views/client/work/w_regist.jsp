    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        events: [ 	
          	 <%for(Work work:workList){%>
   	        	 {
   	        		<%if(work.getW_name().equals("외근")){%>
   	     			color : "#FFA500",
   	     		<%}else if(work.getW_name().equals("출장")){%>
   	     			color : "#FFD700",
   	     		<%}else if(work.getW_name().equals("야근")){%>
   	     			color :"#F6C1CE",
   	     		<%}%>
   	        		<%if(work.getW_status()==0){%>
   		    	 		title:'<%=work.getW_name()+"   - 승인대기중"%>',	        		
   	        		<%}else{%>
   	        		title:'<%=work.getW_name()%>',
   	        		<%}%>
   	    	 		start: '<%=work.getW_date()%>',
   	        	 },
          	 <%}%>
           ],
...
<body id="page-top">
    ...
    <div id="wrapper">  
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="row">
                    	...
                    	<div class="col-xl-4">
	                    	<div class="col-md-12">
								...
								<!-- 선택한 날의 근무 일정 -->
								<!-- <div class="page-header" id="header_p" style="width: 700px;">
									<h2>근무 일정</h2>
								</div> -->
            ...
            <!-- End of Main Content -->
			<!--승인권자 모달창  -->		
			<%@include file="../inc/work_modal.jsp"%>
            <!-- Footer -->
